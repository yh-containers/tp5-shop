...
CREATE TABLE `sp_s_order`  (
  ...
  `delete_time` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '订单表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sp_s_order
-- ----------------------------
INSERT INTO `sp_s_order` VALUES (1, 1, '2018112718330238500005', 1, 1, 'abc', 18702783600, '4536', '天津市', '天津市市辖区', '和平区', 'cccc', 1, 3099.00, 3099.00, 0.00, 0.00, 'fghdfghdfghdfgh', 0x7B22696E765F7061796565223A22E68891E79A84E58F91E7A5A8E68AACE5A4B4222C227461785F636F6465223A22E699AEE9809AE7BAB3E7A88EE4BABAE8AF86E588ABE58FB7222C2274797065223A307D, 0, 0, 0, 2, 1, NULL, 1543370481, NULL, NULL, 1543314782, 1543370481, NULL);
INSERT INTO `sp_s_order` VALUES (2, 0, '2018112819175061800001', 1, 1, 'x', 18702783614, '2134', '山西省', '大同市', '矿区', 'x234', 1, 3988.00, 3988.00, 0.00, 0.00, '我的范德萨发射点发', 0x7B22696E765F7061796565223A22E68891E79A84E58F91E7A5A8E68AACE5A4B4222C227461785F636F6465223A22E699AEE9809AE7BAB3E7A88EE4BABAE8AF86E588ABE58FB7222C2274797065223A307D, 0, 0, 0, 2, 1, NULL, 1543403918, NULL, NULL, 1543403870, 1543403918, NULL);
...
INSERT INTO `sp_s_order_goods` VALUES (2, 0, 2, 26, 57, '海信（Hisense）HZ65E5A 65英寸 超高清4K HDR Unibody一体超薄 AI人工智能电视', 3988.00, 1, 'uploads\\images\\normal\\20181107\\5eb94dc8745d5c5231b77cf622b03666.jpg', '银色\r\n标准版\r\n55英寸4K 人工智能+HDR+超窄边框', 3988.00, 0, );

-- ----------------------------
-- Table structure for sp_s_order_goods_back
-- ----------------------------
DROP TABLE IF EXISTS `sp_s_order_goods_back`;
CREATE TABLE `sp_s_order_goods_back`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `uid` int(11) NULL DEFAULT NULL,
  `og_id` int(11) NULL DEFAULT NULL COMMENT '订单商品关联id',
  `logistics_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '物流名称',
  `logistics_no` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '物流单号',
  `is_send` tinyint(4) NULL DEFAULT 0 COMMENT '1已发货 2已收货',
  `status` tinyint(4) NULL DEFAULT 1 COMMENT '0取消 1创建  2允许发货 3申请被拒  4完成',
  `auth_time` int(11) NULL DEFAULT NULL COMMENT '允许发货',
  ...
  `delete_time` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `og_id`(`og_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '订单商品退款流程' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sp_s_order_goods_back
-- ----------------------------
INSERT INTO `sp_s_order_goods_back` VALUES (8, '2018112818051637900012', 1, 1, NULL, NULL, 0, 3, 1543400885, NULL, NULL, NULL, NULL, 1543399516, 1543400885, NULL);
INSERT INTO `sp_s_order_goods_back` VALUES (9, '2018112818493771000013', 1, 1, 'sdf', '234', 2, 4, 1543402185, NULL, 1543402195, 1543403190, 1543403586, 1543402177, 1543403586, NULL);
INSERT INTO `sp_s_order_goods_back` VALUES (10, '2018112819185126200014', 1, 2, '234', '653346', 2, 4, 1543403954, NULL, 1543404003, 1543404010, 1543404023, 1543403931, 1543404023, NULL);
...
-- ----------------------------
-- Table structure for sp_s_user_back_flow
-- ----------------------------
DROP TABLE IF EXISTS `sp_s_user_back_flow`;
CREATE TABLE `sp_s_user_back_flow`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fid` int(11) NULL DEFAULT NULL,
  `content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `img` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL,
  `create_time` int(11) NULL DEFAULT NULL,
  `update_time` int(11) NULL DEFAULT NULL,
  `delete_time` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fid`(`fid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '用户申请退货流程' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sp_s_user_back_flow
-- ----------------------------
INSERT INTO `sp_s_user_back_flow` VALUES (16, 8, '1231231232132142343453', '', 1543399516, 1543399516, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (17, 8, 'asdfasdfasdfasdf', '', 1543399522, 1543399522, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (18, 8, '开放发货申请', NULL, 1543400837, 1543400837, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (19, 8, '您的申请被拒', NULL, 1543400885, 1543400885, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (20, 8, 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', '', 1543401640, 1543401640, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (21, 8, '44444444444444444444444444444444444444', '', 1543401828, 1543401828, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (22, 8, '222222222222222222222222222', '', 1543401915, 1543401915, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (23, 8, '523232323232323232323232323232323232323', '', 1543401948, 1543401948, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (24, 8, '233333333333', '', 1543401972, 1543401972, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (25, 9, '2342342345345345', '', 1543402177, 1543402177, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (26, 9, '开放发货申请', NULL, 1543402185, 1543402185, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (27, 9, '添加物流信息', NULL, 1543402195, 1543402195, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (28, 9, '商家确定收货', NULL, 1543403191, 1543403191, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (29, 9, '退货流程已完成', NULL, 1543403586, 1543403586, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (30, 10, 'asdfasdfasdfasdfasdfasdf', 'uploads\\images\\back_goods\\20181128\\374aff515bcb94f2d88597e92e34bf24.jpg', 1543403931, 1543403931, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (31, 10, '23543254345325325235325', '', 1543403942, 1543403942, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (32, 10, '开放发货申请', NULL, 1543403954, 1543403954, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (33, 10, '34534534535345', '', 1543403963, 1543403963, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (34, 10, '添加物流信息', NULL, 1543404003, 1543404003, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (35, 10, '商家确定收货', NULL, 1543404010, 1543404010, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (36, 10, '234234234234234234', '', 1543404019, 1543404019, NULL);
INSERT INTO `sp_s_user_back_flow` VALUES (37, 10, '退货流程已完成', NULL, 1543404023, 1543404023, NULL);
...
INSERT INTO `sp_sys_node` VALUES (31, '退款订单', 'Order/refund', 'shop', NULL, 15, 0, NULL, 100);
